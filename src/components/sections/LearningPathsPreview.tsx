              ...
              >
                ...
                {path.image && (
                  <>
                    ...
                    <div className="w-full md:hidden flex justify-center mb-6 z-10">
                      <div className="relative w-[180px] h-[315px] sm:w-[210px] sm:h-[368px] select-none pointer-events-none drop-shadow-[0_12px_24px_rgba(249,115,22,0.12)] group-hover:drop-shadow-[0_16px_32px_rgba(249,115,22,0.22)] group-hover:scale-[1.03] group-hover:rotate-1 transition-all duration-500">
                          ...
                          <div className="relative w-full h-full rounded-[1.7rem] overflow-hidden bg-slate-950 border border-slate-800">
                            ...
                            <div className="w-full h-full relative">
                              <Image 
                                ...
                                alt={path.title} 
                                fill 
                                sizes="(max-width: 640px) 180px, (max-width: 768px) 210px"
                    ...
                    <div className="hidden md:block w-full h-48 rounded-2xl relative overflow-hidden mb-6 border border-slate-100 bg-slate-50 z-10 shadow-sm group-hover:shadow-md group-hover:scale-[1.01] transition-all duration-500">
                      <Image 
                        src={path.image} 
                        alt={path.title} 
                        fill 
